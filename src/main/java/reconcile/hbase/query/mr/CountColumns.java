...
private static final Log LOG = LogFactory.getLog(CountColumns.class);
...
{
  try {
    ToolRunner.run(new Configuration(), new CountColumns(), args);
  }
  catch (Exception e) {
    e.printStackTrace();
  }
    ...
    throws Exception
{
  ...
  try {
    ...
    job.setJarByClass(CountColumns.class);
